...
INSERT INTO `catagories` (`category_id`, `name`, `desecription`) VALUES
...
(1, 1, 4, 78, 'Alex', 'Tan', 3200000001, 95),
(2, 1, 4, 79, 'Brian', 'Lim', 3200000002, 92),
(3, 1, 4, 80, 'Chloe', 'Ng', 3200000003, 88),
(4, 1, 3, 81, 'Dylan', 'Ong', 3200000004, 84),
(5, 2, 3, 82, 'Ethan', 'Goh', 3200000005, 86),
(6, 3, 3, 83, 'Fiona', 'Teo', 3200000006, 90),
(7, 4, 3, 84, 'Grace', 'Lee', 3200000007, 83),
...
(1, 'Staff', 1500.00),
(2, 'Finance', 1800.00),
(3, 'Store Manager', 1900.00),
(4, 'Head Office', 2000.00);
...
INSERT INTO `members` (`member_id`, `user_id`, `member_tier_id`, `first_name`, `last_name`, `phone`, `point`, `address`, `birthday`) VALUES
(1, 1, 1, 'Ethan', 'Smith', 3100000001, 120, 'Blk 10, Street 1', '1996-05-12'),
(2, 2, 1, 'Olivia', 'Johnson', 3100000002, 80, '', NULL),
(3, 3, 1, 'Noah', 'Brown', 3100000003, 150, NULL, '1993-11-03'),
(4, 4, 1, 'Ava', 'Taylor', 3100000004, 60, 'Blk 13, Street 4', NULL),
(5, 5, 1, 'Liam', 'Anderson', 3100000005, 200, NULL, '1990-02-20'),
(6, 6, 1, 'Mia', 'Thomas', 3100000006, 45, NULL, NULL),
(7, 7, 1, 'Lucas', 'Jackson', 3100000007, 95, 'Blk 16, Street 7', NULL),
(8, 8, 1, 'Sophia', 'White', 3100000008, 30, 'Blk 17, Street 8', NULL),
(9, 9, 1, 'Mason', 'Harris', 3100000009, 110, NULL, '1995-09-08'),
(10, 10, 1, 'Isabella', 'Martin', 3100000010, 75, NULL, NULL),
(11, 11, 1, 'Logan', 'Thompson', 3100000011, 160, 'Blk 20, Street 11', '1992-12-25'),
(12, 12, 1, 'Amelia', 'Garcia', 3100000012, 55, NULL, NULL),
(13, 13, 1, 'James', 'Martinez', 3100000013, 140, 'Blk 22, Street 13', '1997-03-14'),
(14, 14, 1, 'Harper', 'Robinson', 3100000014, 20, 'Blk 23, Street 14', NULL),
(15, 15, 1, 'Benjamin', 'Clark', 3100000015, 85, NULL, '1991-08-30'),
(16, 16, 1, 'Evelyn', 'Rodriguez', 3100000016, 90, 'Blk 25, Street 16', NULL),
(17, 17, 1, 'Henry', 'Lewis', 3100000017, 130, 'Blk 26, Street 17', '1994-10-10'),
(18, 18, 1, 'Abigail', 'Lee', 3100000018, 40, NULL, NULL),
(19, 19, 1, 'Alexander', 'Walker', 3100000019, 105, 'Blk 28, Street 19', '1999-01-01'),
(20, 20, 1, 'Emily', 'Hall', 3100000020, 70, NULL, NULL),
(21, 21, 1, 'Daniel', 'Allen', 3100000021, 115, NULL, NULL),
(22, 22, 1, 'Ella', 'Young', 3100000022, 65, 'Blk 31, Street 22', NULL),
(23, 23, 1, 'Michael', 'Hernandez', 3100000023, 125, 'Blk 32, Street 23', '1996-04-22'),
(24, 24, 1, 'Avery', 'King', 3100000024, 35, NULL, NULL),
(25, 25, 1, 'Jackson', 'Wright', 3100000025, 155, NULL, '1993-09-17'),
(26, 26, 1, 'Scarlett', 'Lopez', 3100000026, 50, 'Blk 35, Street 26', NULL),
(27, 27, 1, 'Sebastian', 'Hill', 3100000027, 100, NULL, '1992-02-02'),
(28, 28, 1, 'Grace', 'Scott', 3100000028, 25, 'Blk 37, Street 28', NULL),
(29, 29, 1, 'Jack', 'Green', 3100000029, 135, 'Blk 38, Street 29', '1998-12-12'),
(30, 30, 1, 'Chloe', 'Adams', 3100000030, 85, NULL, NULL),
(31, 31, 1, 'Owen', 'Baker', 3100000031, 95, 'Blk 40, Street 31', '1995-07-07'),
(32, 32, 1, 'Lily', 'Gonzalez', 3100000032, 60, 'Blk 41, Street 32', NULL),
(33, 33, 1, 'Matthew', 'Nelson', 3100000033, 150, NULL, '1991-03-03'),
(34, 34, 1, 'Hannah', 'Carter', 3100000034, 45, 'Blk 43, Street 34', NULL),
(35, 35, 1, 'Samuel', 'Mitchell', 3100000035, 110, NULL, NULL),
(36, 36, 1, 'Zoey', 'Perez', 3100000036, 70, NULL, NULL),
(37, 37, 1, 'Joseph', 'Roberts', 3100000037, 90, 'Blk 46, Street 37', '1994-04-04'),
(38, 38, 1, 'Nora', 'Turner', 3100000038, 55, 'Blk 47, Street 38', NULL),
(39, 39, 1, 'David', 'Phillips', 3100000039, 140, NULL, '1996-06-16'),
(40, 40, 1, 'Riley', 'Campbell', 3100000040, 65, NULL, NULL),
(41, 41, 2, 'Wyatt', 'Parker', 3100000041, 260, 'Blk 50, Street 41', '1992-05-05'),
(42, 42, 2, 'Victoria', 'Evans', 3100000042, 220, NULL, NULL),
(43, 43, 2, 'John', 'Edwards', 3100000043, 300, 'Blk 52, Street 43', '1990-10-20'),
(44, 44, 2, 'Aria', 'Collins', 3100000044, 240, 'Blk 53, Street 44', NULL),
(45, 45, 2, 'Luke', 'Stewart', 3100000045, 280, NULL, '1997-02-14'),
(46, 46, 2, 'Penelope', 'Sanchez', 3100000046, 210, 'Blk 55, Street 46', NULL),
(47, 47, 2, 'Gabriel', 'Morris', 3100000047, 330, 'Blk 56, Street 47', '1993-03-13'),
(48, 48, 2, 'Layla', 'Rogers', 3100000048, 205, NULL, NULL),
(49, 49, 2, 'Anthony', 'Reed', 3100000049, 290, 'Blk 58, Street 49', NULL),
(50, 50, 2, 'Lillian', 'Cook', 3100000050, 235, NULL, NULL),
(51, 51, 2, 'Isaac', 'Morgan', 3100000051, 310, NULL, '1991-01-21'),
(52, 52, 2, 'Addison', 'Bell', 3100000052, 225, 'Blk 61, Street 52', NULL),
(53, 53, 2, 'Dylan', 'Murphy', 3100000053, 275, 'Blk 62, Street 53', '1998-08-08'),
(54, 54, 2, 'Aubrey', 'Bailey', 3100000054, 215, NULL, NULL),
(55, 55, 2, 'Nathan', 'Rivera', 3100000055, 305, NULL, '1994-12-01'),
(56, 56, 2, 'Savannah', 'Cooper', 3100000056, 245, 'Blk 65, Street 56', NULL),
(57, 57, 2, 'Andrew', 'Richardson', 3100000057, 295, NULL, '1996-09-19'),
(58, 58, 2, 'Brooklyn', 'Cox', 3100000058, 230, 'Blk 67, Street 58', NULL),
(59, 59, 2, 'Joshua', 'Howard', 3100000059, 320, 'Blk 68, Street 59', '1992-06-30'),
(60, 60, 2, 'Bella', 'Ward', 3100000060, 240, NULL, NULL),
(61, 61, 3, 'Christopher', 'Peterson', 3100000061, 520, 'Blk 70, Street 61', '1989-07-07'),
(62, 62, 3, 'Claire', 'Gray', 3100000062, 480, 'Blk 71, Street 62', NULL),
(63, 63, 3, 'Thomas', 'Ramirez', 3100000063, 600, NULL, NULL),
(64, 64, 3, 'Stella', 'James', 3100000064, 450, 'Blk 73, Street 64', NULL),
(65, 65, 3, 'Caleb', 'Watson', 3100000065, 570, NULL, '1993-12-12'),
(66, 66, 3, 'Lucy', 'Brooks', 3100000066, 490, NULL, NULL),
(67, 67, 3, 'Ryan', 'Kelly', 3100000067, 620, 'Blk 76, Street 67', '1995-05-15'),
(68, 68, 3, 'Madison', 'Sanders', 3100000068, 460, 'Blk 77, Street 68', NULL),
(69, 69, 3, 'Adam', 'Price', 3100000069, 585, NULL, '1991-09-09'),
(70, 70, 3, 'Leah', 'Bennett', 3100000070, 510, NULL, NULL),
(71, 71, 3, 'Leo', 'Wood', 3100000071, 640, 'Blk 80, Street 71', '1992-02-22'),
(72, 72, 3, 'Anna', 'Barnes', 3100000072, 500, NULL, NULL),
(73, 73, 4, 'Oscar', 'Ross', 3100000073, 980, 'Blk 82, Street 73', '1988-03-03'),
(74, 74, 4, 'Sienna', 'Henderson', 3100000074, 1100, 'Blk 83, Street 74', NULL),
(75, 75, 4, 'Julian', 'Coleman', 3100000075, 1250, NULL, '1990-10-10'),
(76, 76, 4, 'Eva', 'Jenkins', 3100000076, 900, 'Blk 85, Street 76', NULL),
(77, 77, 4, 'Miles', 'Perry', 3100000077, 1400, 'Blk 86, Street 77', NULL);
...
(1, 'member001', 'hash_m001', '2025-01-02 09:00:00', '2025-12-10 20:10:00', 'member', 'active'),
(2, 'member002', 'hash_m002', '2025-01-03 09:00:00', '2025-12-11 20:10:00', 'member', 'active'),
(3, 'member003', 'hash_m003', '2025-01-04 09:00:00', '2025-12-12 20:10:00', 'member', 'active'),
(4, 'member004', 'hash_m004', '2025-01-05 09:00:00', '2025-12-13 20:10:00', 'member', 'active'),
(5, 'member005', 'hash_m005', '2025-01-06 09:00:00', '2025-12-14 20:10:00', 'member', 'active'),
(6, 'member006', 'hash_m006', '2025-01-07 09:00:00', '2025-12-15 20:10:00', 'member', 'active'),
(7, 'member007', 'hash_m007', '2025-01-08 09:00:00', '2025-12-16 20:10:00', 'member', 'active'),
(8, 'member008', 'hash_m008', '2025-01-09 09:00:00', '2025-12-17 20:10:00', 'member', 'active'),
(9, 'member009', 'hash_m009', '2025-01-10 09:00:00', '2025-12-18 20:10:00', 'member', 'active'),
(10, 'member010', 'hash_m010', '2025-01-11 09:00:00', '2025-12-09 20:10:00', 'member', 'active'),
(11, 'member011', 'hash_m011', '2025-01-12 09:00:00', '2025-12-10 20:10:00', 'member', 'active'),
(12, 'member012', 'hash_m012', '2025-01-13 09:00:00', '2025-12-11 20:10:00', 'member', 'active'),
(13, 'member013', 'hash_m013', '2025-01-14 09:00:00', '2025-12-12 20:10:00', 'member', 'active'),
(14, 'member014', 'hash_m014', '2025-01-15 09:00:00', '2025-12-13 20:10:00', 'member', 'active'),
(15, 'member015', 'hash_m015', '2025-01-16 09:00:00', '2025-12-14 20:10:00', 'member', 'active'),
(16, 'member016', 'hash_m016', '2025-01-17 09:00:00', '2025-12-15 20:10:00', 'member', 'active'),
(17, 'member017', 'hash_m017', '2025-01-18 09:00:00', '2025-12-16 20:10:00', 'member', 'active'),
(18, 'member018', 'hash_m018', '2025-01-19 09:00:00', '2025-12-17 20:10:00', 'member', 'active'),
(19, 'member019', 'hash_m019', '2025-01-20 09:00:00', '2025-12-18 20:10:00', 'member', 'active'),
(20, 'member020', 'hash_m020', '2025-01-21 09:00:00', '2025-12-09 20:10:00', 'member', 'active'),
(21, 'member021', 'hash_m021', '2025-01-22 09:00:00', '2025-12-10 20:10:00', 'member', 'active'),
(22, 'member022', 'hash_m022', '2025-01-23 09:00:00', '2025-12-11 20:10:00', 'member', 'active'),
(23, 'member023', 'hash_m023', '2025-01-24 09:00:00', '2025-12-12 20:10:00', 'member', 'active'),
(24, 'member024', 'hash_m024', '2025-01-25 09:00:00', '2025-12-13 20:10:00', 'member', 'active'),
(25, 'member025', 'hash_m025', '2025-01-26 09:00:00', '2025-12-14 20:10:00', 'member', 'active'),
(26, 'member026', 'hash_m026', '2025-01-27 09:00:00', '2025-12-15 20:10:00', 'member', 'active'),
(27, 'member027', 'hash_m027', '2025-01-28 09:00:00', '2025-12-16 20:10:00', 'member', 'active'),
(28, 'member028', 'hash_m028', '2025-01-29 09:00:00', '2025-12-17 20:10:00', 'member', 'active'),
(29, 'member029', 'hash_m029', '2025-01-30 09:00:00', '2025-12-18 20:10:00', 'member', 'active'),
(30, 'member030', 'hash_m030', '2025-01-31 09:00:00', '2025-12-09 20:10:00', 'member', 'active'),
(31, 'member031', 'hash_m031', '2025-02-01 09:00:00', '2025-12-10 20:10:00', 'member', 'active'),
(32, 'member032', 'hash_m032', '2025-02-02 09:00:00', '2025-12-11 20:10:00', 'member', 'active'),
(33, 'member033', 'hash_m033', '2025-02-03 09:00:00', '2025-12-12 20:10:00', 'member', 'active'),
(34, 'member034', 'hash_m034', '2025-02-04 09:00:00', '2025-12-13 20:10:00', 'member', 'active'),
(35, 'member035', 'hash_m035', '2025-02-05 09:00:00', '2025-12-14 20:10:00', 'member', 'active'),
(36, 'member036', 'hash_m036', '2025-02-06 09:00:00', '2025-12-15 20:10:00', 'member', 'active'),
(37, 'member037', 'hash_m037', '2025-02-07 09:00:00', '2025-12-16 20:10:00', 'member', 'active'),
(38, 'member038', 'hash_m038', '2025-02-08 09:00:00', '2025-12-17 20:10:00', 'member', 'active'),
(39, 'member039', 'hash_m039', '2025-02-09 09:00:00', '2025-12-18 20:10:00', 'member', 'active'),
(40, 'member040', 'hash_m040', '2025-02-10 09:00:00', '2025-12-09 20:10:00', 'member', 'active'),
(41, 'member041', 'hash_m041', '2025-02-11 09:00:00', '2025-12-10 20:10:00', 'member', 'active'),
(42, 'member042', 'hash_m042', '2025-02-12 09:00:00', '2025-12-11 20:10:00', 'member', 'active'),
(43, 'member043', 'hash_m043', '2025-02-13 09:00:00', '2025-12-12 20:10:00', 'member', 'active'),
(44, 'member044', 'hash_m044', '2025-02-14 09:00:00', '2025-12-13 20:10:00', 'member', 'active'),
(45, 'member045', 'hash_m045', '2025-02-15 09:00:00', '2025-12-14 20:10:00', 'member', 'active'),
(46, 'member046', 'hash_m046', '2025-02-16 09:00:00', '2025-12-15 20:10:00', 'member', 'active'),
(47, 'member047', 'hash_m047', '2025-02-17 09:00:00', '2025-12-16 20:10:00', 'member', 'active'),
(48, 'member048', 'hash_m048', '2025-02-18 09:00:00', '2025-12-17 20:10:00', 'member', 'active'),
(49, 'member049', 'hash_m049', '2025-02-19 09:00:00', '2025-12-18 20:10:00', 'member', 'active'),
(50, 'member050', 'hash_m050', '2025-02-20 09:00:00', '2025-12-09 20:10:00', 'member', 'active'),
(51, 'member051', 'hash_m051', '2025-02-21 09:00:00', '2025-12-10 20:10:00', 'member', 'active'),
(52, 'member052', 'hash_m052', '2025-02-22 09:00:00', '2025-12-11 20:10:00', 'member', 'active'),
(53, 'member053', 'hash_m053', '2025-02-23 09:00:00', '2025-12-12 20:10:00', 'member', 'active'),
(54, 'member054', 'hash_m054', '2025-02-24 09:00:00', '2025-12-13 20:10:00', 'member', 'active'),
(55, 'member055', 'hash_m055', '2025-02-25 09:00:00', '2025-12-14 20:10:00', 'member', 'active'),
(56, 'member056', 'hash_m056', '2025-02-26 09:00:00', '2025-12-15 20:10:00', 'member', 'active'),
(57, 'member057', 'hash_m057', '2025-02-27 09:00:00', '2025-12-16 20:10:00', 'member', 'active'),
(58, 'member058', 'hash_m058', '2025-02-28 09:00:00', '2025-12-17 20:10:00', 'member', 'active'),
(59, 'member059', 'hash_m059', '2025-03-01 09:00:00', '2025-12-18 20:10:00', 'member', 'active'),
(60, 'member060', 'hash_m060', '2025-03-02 09:00:00', '2025-12-09 20:10:00', 'member', 'active'),
(61, 'member061', 'hash_m061', '2025-03-03 09:00:00', '2025-12-10 20:10:00', 'member', 'active'),
(62, 'member062', 'hash_m062', '2025-03-04 09:00:00', '2025-12-11 20:10:00', 'member', 'active'),
(63, 'member063', 'hash_m063', '2025-03-05 09:00:00', '2025-12-12 20:10:00', 'member', 'active'),
(64, 'member064', 'hash_m064', '2025-03-06 09:00:00', '2025-12-13 20:10:00', 'member', 'active'),
(65, 'member065', 'hash_m065', '2025-03-07 09:00:00', '2025-12-14 20:10:00', 'member', 'active'),
(66, 'member066', 'hash_m066', '2025-03-08 09:00:00', '2025-12-15 20:10:00', 'member', 'active'),
(67, 'member067', 'hash_m067', '2025-03-09 09:00:00', '2025-12-16 20:10:00', 'member', 'active'),
(68, 'member068', 'hash_m068', '2025-03-10 09:00:00', '2025-12-17 20:10:00', 'member', 'active'),
(69, 'member069', 'hash_m069', '2025-03-11 09:00:00', '2025-12-18 20:10:00', 'member', 'active'),
(70, 'member070', 'hash_m070', '2025-03-12 09:00:00', '2025-12-09 20:10:00', 'member', 'active'),
(71, 'member071', 'hash_m071', '2025-03-13 09:00:00', '2025-12-10 20:10:00', 'member', 'active'),
(72, 'member072', 'hash_m072', '2025-03-14 09:00:00', '2025-12-11 20:10:00', 'member', 'active'),
(73, 'member073', 'hash_m073', '2025-03-15 09:00:00', '2025-12-12 20:10:00', 'member', 'active'),
(74, 'member074', 'hash_m074', '2025-03-16 09:00:00', '2025-12-13 20:10:00', 'member', 'active'),
(75, 'member075', 'hash_m075', '2025-03-17 09:00:00', '2025-12-14 20:10:00', 'member', 'active'),
(76, 'member076', 'hash_m076', '2025-03-18 09:00:00', '2025-12-15 20:10:00', 'member', 'active'),
(77, 'member077', 'hash_m077', '2025-03-19 09:00:00', '2025-12-16 20:10:00', 'member', 'active'),
(78, 'emp001', 'hash_e001', '2024-11-01 08:30:00', '2025-12-18 09:05:00', 'employee', 'active'),
(79, 'emp002', 'hash_e002', '2024-11-08 08:30:00', '2025-12-18 09:05:00', 'employee', 'active'),
(80, 'emp003', 'hash_e003', '2024-11-15 08:30:00', '2025-12-18 09:05:00', 'employee', 'active'),
(81, 'emp004', 'hash_e004', '2024-11-22 08:30:00', '2025-12-18 09:05:00', 'employee', 'active'),
(82, 'emp005', 'hash_e005', '2024-11-29 08:30:00', '2025-12-18 09:05:00', 'employee', 'active'),
(83, 'emp006', 'hash_e006', '2024-12-06 08:30:00', '2025-12-18 09:05:00', 'employee', 'active'),
(84, 'emp007', 'hash_e007', '2024-12-13 08:30:00', '2025-12-18 09:05:00', 'employee', 'active'),
(85, 'emp008', 'hash_e008', '2024-12-20 08:30:00', '2025-12-18 09:05:00', 'employee', 'active'),
(86, 'emp009', 'hash_e009', '2025-01-03 08:30:00', '2025-12-18 09:05:00', 'employee', 'active'),
(87, 'emp010', 'hash_e010', '2025-01-10 08:30:00', '2025-12-18 09:05:00', 'employee', 'active'),
(88, 'emp011', 'hash_e011', '2025-01-17 08:30:00', '2025-12-18 09:05:00', 'employee', 'active'),
(89, 'emp012', 'hash_e012', '2025-01-24 08:30:00', '2025-12-18 09:05:00', 'employee', 'active'),
(90, 'emp013', 'hash_e013', '2025-01-31 08:30:00', '2025-12-18 09:05:00', 'employee', 'active'),
(91, 'emp014', 'hash_e014', '2025-02-07 08:30:00', '2025-12-18 09:05:00', 'employee', 'active'),
(92, 'emp015', 'hash_e015', '2025-02-14 08:30:00', '2025-12-18 09:05:00', 'employee', 'active'),
(93, 'emp016', 'hash_e016', '2025-02-21 08:30:00', '2025-12-18 09:05:00', 'employee', 'active'),
(94, 'emp017', 'hash_e017', '2025-02-28 08:30:00', '2025-12-18 09:05:00', 'employee', 'active'),
(95, 'emp018', 'hash_e018', '2025-03-07 08:30:00', '2025-12-18 09:05:00', 'employee', 'active'),
(96, 'emp019', 'hash_e019', '2025-03-14 08:30:00', '2025-12-18 09:05:00', 'employee', 'active'),
(97, 'emp020', 'hash_e020', '2025-03-21 08:30:00', '2025-12-18 09:05:00', 'employee', 'active'),
(98, 'emp021', 'hash_e021', '2025-03-28 08:30:00', '2025-12-18 09:05:00', 'employee', 'active'),
(99, 'emp022', 'hash_e022', '2025-04-04 08:30:00', '2025-12-18 09:05:00', 'employee', 'active'),
(100, 'emp023', 'hash_e023', '2025-04-11 08:30:00', '2025-12-18 09:05:00', 'employee', 'active');
...
,`store_id` int(11)
,`member_id` int(11)
,`order_status` enum('created','paid','cancelled','refunded')
,`order_date` datetime
...
,`head_office_count` decimal(22,0)
...
--
-- 替换视图以便查看 `vw_manager_store_performance`
-- （参见下面的实际视图）
--
CREATE TABLE `vw_manager_store_performance` (
`store_id` int(11)
,`store_name` varchar(50)
,`status` enum('close','open','top sales')
,`telephone` int(11)
,`total_orders` bigint(21)
,`revenue` decimal(41,2)
,`unique_customers` bigint(21)
,`staff_count` bigint(21)
,`avg_employee_performance` decimal(13,2)
,`inventory_value` decimal(41,2)
,`total_inventory` decimal(32,0)
,`revenue_per_employee` decimal(42,2)
,`revenue_rank` bigint(21)
);
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_manager_payment_analysis`  AS SELECT `p`.`payment_method` AS `payment_method`, count(distinct `p`.`payment_id`) AS `payment_count`, coalesce(sum(`p`.`amount`),0) AS `total_amount`, avg(`p`.`amount`) AS `avg_amount`, min(`p`.`amount`) AS `min_amount`, max(`p`.`amount`) AS `max_amount`, count(distinct `o`.`store_id`) AS `stores_count`, cast(min(`p`.`create_date`) as date) AS `first_payment_date`, cast(max(`p`.`create_date`) as date) AS `last_payment_date`, round(coalesce(sum(`p`.`amount`),0) / nullif((select sum(`payments`.`amount`) from `payments`),0) * 100,2) AS `percentage_of_total` FROM (((`payments` `p` left join `payment_allocations` `pa` on(`p`.`payment_id` = `pa`.`payment_id`)) left join `invoices` `inv` on(`pa`.`invoice_id` = `inv`.`invoice_id`)) left join `orders` `o` on(`inv`.`order_id` = `o`.`order_id`)) GROUP BY `p`.`payment_method` ORDER BY coalesce(sum(`p`.`amount`),0) DESC ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_manager_sales_by_store`  AS SELECT `st`.`store_id` AS `store_id`, `st`.`name` AS `store_name`, `st`.`status` AS `store_status`, count(distinct `o`.`order_id`) AS `total_orders`, count(distinct case when `o`.`order_status` = 'paid' then `o`.`order_id` end) AS `paid_orders`, count(distinct `o`.`member_id`) AS `unique_customers`, coalesce(sum(case when `o`.`order_status` = 'paid' then `oi`.`quantity` * `s`.`unit_price` else 0 end),0) AS `total_revenue`, avg(case when `o`.`order_status` = 'paid' then `oi`.`quantity` * `s`.`unit_price` end) AS `avg_order_value`, coalesce(sum(case when `o`.`order_status` = 'paid' then `oi`.`quantity` else 0 end),0) AS `total_items_sold`, cast(max(`o`.`order_date`) as date) AS `last_order_date` FROM (((`stores` `st` left join `orders` `o` on(`st`.`store_id` = `o`.`store_id`)) left join `order_items` `oi` on(`o`.`order_id` = `oi`.`order_id`)) left join `skus` `s` on(`oi`.`sku_id` = `s`.`sku_id`)) GROUP BY `st`.`store_id`, `st`.`name`, `st`.`status` ORDER BY coalesce(sum(case when `o`.`order_status` = 'paid' then `oi`.`quantity` * `s`.`unit_price` else 0 end),0) DESC ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_manager_staff_by_store`  AS SELECT `s`.`store_id` AS `store_id`, `s`.`name` AS `store_name`, `s`.`status` AS `store_status`, count(distinct `e`.`employee_id`) AS `total_employees`, sum(case when `jt`.`name` = 'Store Manager' then 1 else 0 end) AS `managers_count`, sum(case when `jt`.`name` = 'Finance' then 1 else 0 end) AS `finance_count`, sum(case when `jt`.`name` = 'Staff' then 1 else 0 end) AS `staff_count`, sum(case when `jt`.`name` = 'Head Office' then 1 else 0 end) AS `head_office_count`, round(avg(`e`.`performance`),2) AS `avg_performance`, sum(`jt`.`base_salary`) AS `total_salary_cost` FROM ((`stores` `s` left join `employees` `e` on(`s`.`store_id` = `e`.`store_id`)) left join `job_titles` `jt` on(`e`.`job_title_id` = `jt`.`job_title_id`)) GROUP BY `s`.`store_id`, `s`.`name`, `s`.`status` ORDER BY count(distinct `e`.`employee_id`) DESC ;

-- --------------------------------------------------------

--
-- 视图结构 `vw_manager_store_performance`
--
DROP TABLE IF EXISTS `vw_manager_store_performance`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_manager_store_performance`  AS SELECT `st`.`store_id` AS `store_id`, `st`.`name` AS `store_name`, `st`.`status` AS `status`, `st`.`telephone` AS `telephone`, count(distinct `o`.`order_id`) AS `total_orders`, coalesce(sum(case when `o`.`order_status` = 'paid' then `oi`.`quantity` * `s`.`unit_price` else 0 end),0) AS `revenue`, count(distinct `o`.`member_id`) AS `unique_customers`, count(distinct `e`.`employee_id`) AS `staff_count`, round(avg(`e`.`performance`),2) AS `avg_employee_performance`, coalesce(sum(`ib`.`quantity` * `ib`.`unit_cost`),0) AS `inventory_value`, coalesce(sum(`ib`.`quantity`),0) AS `total_inventory`, round(coalesce(sum(case when `o`.`order_status` = 'paid' then `oi`.`quantity` * `s`.`unit_price` else 0 end),0) / nullif(count(distinct `e`.`employee_id`),0),2) AS `revenue_per_employee`, rank() over ( order by sum(case when `o`.`order_status` = 'paid' then `oi`.`quantity` * `s`.`unit_price` else 0 end) desc) AS `revenue_rank` FROM (((((`stores` `st` left join `orders` `o` on(`st`.`store_id` = `o`.`store_id`)) left join `order_items` `oi` on(`o`.`order_id` = `oi`.`order_id`)) left join `skus` `s` on(`oi`.`sku_id` = `s`.`sku_id`)) left join `employees` `e` on(`st`.`store_id` = `e`.`store_id`)) left join `inventory_batches` `ib` on(`st`.`store_id` = `ib`.`store_id`)) GROUP BY `st`.`store_id`, `st`.`name`, `st`.`status`, `st`.`telephone` ORDER BY coalesce(sum(case when `o`.`order_status` = 'paid' then `oi`.`quantity` * `s`.`unit_price` else 0 end),0) DESC ;
...
('root', '[{\"db\":\"information_schema\",\"table\":\"TABLES\"}]');
...
('root', '2025-12-29 06:01:09', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"zh_CN\"}');
