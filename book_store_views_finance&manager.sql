...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '85dc8b77-b958-11f0-938e-e86a642b8f60:1-281';
...
INSERT INTO `point_ledgers` VALUES (1,1,'2025-11-01 10:21:00','points for paid order',0),(2,2,'2025-11-01 11:34:00','points for paid order',0),(3,3,'2025-11-02 09:39:00','points for paid order',0),(4,4,'2025-11-02 15:49:00','points for paid order',0),(5,5,'2025-11-03 11:29:00','points for paid order',0),(6,6,'2025-11-03 13:24:00','points for paid order',0),(7,7,'2025-11-04 19:14:00','points for paid order',0),(8,8,'2025-11-05 11:04:00','points for paid order',0),(9,9,'2025-11-05 12:19:00','points for paid order',0),(10,10,'2025-11-06 15:31:00','points for paid order',0),(11,11,'2025-11-07 09:27:00','points for paid order',0),(12,12,'2025-11-07 20:10:00','points for paid order',0),(13,13,'2025-11-08 11:20:00','points for paid order',0),(14,14,'2025-11-09 17:54:00','points for paid order',0),(15,15,'2025-11-10 08:44:00','points for paid order',0),(16,16,'2025-11-10 14:59:00','points for paid order',0),(17,23,'2025-11-14 09:19:00','points for paid order',0),(18,24,'2025-11-14 11:14:00','points for paid order',0),(19,25,'2025-11-14 15:31:00','points for paid order',0),(20,26,'2025-11-15 10:39:00','points for paid order',0),(21,27,'2025-11-15 12:49:00','points for paid order',0),(22,28,'2025-11-15 16:27:00','points for paid order',0),(23,29,'2025-11-16 09:21:00','points for paid order',0),(24,30,'2025-11-16 14:04:00','points for paid order',0),(25,31,'2025-11-16 19:19:00','points for paid order',0),(26,32,'2025-11-17 10:11:00','points for paid order',0),(27,33,'2025-11-17 14:46:00','points for paid order',0),(28,34,'2025-11-17 20:29:00','points for paid order',0);
...
INSERT INTO `purchases` VALUES (1,1,1,'2025-11-01 10:00:00','Monthly restock','pending'),(2,1,2,'2025-11-08 10:00:00','Top sellers replenishment','pending'),(3,1,3,'2025-11-15 10:00:00',NULL,'pending'),(4,1,4,'2025-11-22 10:00:00','Holiday preparation','pending'),(5,1,5,'2025-11-29 10:00:00',NULL,'pending'),(6,2,6,'2025-11-03 11:00:00','Weekly restock','pending'),(7,2,7,'2025-11-10 11:00:00',NULL,'pending'),(8,2,8,'2025-11-17 11:00:00','New arrivals','pending'),(9,2,9,'2025-11-24 11:00:00',NULL,'pending'),(10,3,10,'2025-11-05 12:00:00','Inventory balancing','pending'),(11,3,11,'2025-11-12 12:00:00',NULL,'pending'),(12,3,12,'2025-11-19 12:00:00','Classic series restock','pending'),(13,4,13,'2025-11-07 14:00:00',NULL,'pending'),(14,4,14,'2025-11-21 14:00:00','Local demand','pending'),(15,4,15,'2025-11-09 16:00:00','New store initial stock','pending'),(16,1,6,'2025-12-01 10:00:00','Supplement restock','pending'),(17,1,7,'2025-12-05 10:00:00',NULL,'pending'),(18,1,8,'2025-12-10 10:00:00','Holiday refill','pending'),(19,2,9,'2025-12-02 11:00:00',NULL,'pending'),(20,2,10,'2025-12-07 11:00:00','Popular titles','pending'),(21,2,11,'2025-12-12 11:00:00',NULL,'pending'),(22,3,12,'2025-12-03 12:00:00','Classics restock','pending'),(23,3,13,'2025-12-08 12:00:00',NULL,'pending'),(24,3,14,'2025-12-13 12:00:00',NULL,'pending'),(25,4,15,'2025-12-04 14:00:00',NULL,'pending'),(26,4,16,'2025-12-09 14:00:00','Local demand','pending'),(27,4,17,'2025-12-14 14:00:00',NULL,'pending'),(28,5,18,'2025-12-05 16:00:00','New arrivals','pending'),(29,5,1,'2025-12-10 16:00:00',NULL,'pending'),(30,5,2,'2025-12-15 16:00:00','Year end stock','pending');
...
INSERT INTO `users` VALUES (1,'member001','hash_m001','2025-01-02 09:00:00','2025-12-10 20:10:00','member','active'),(2,'member002','hash_m002','2025-01-03 09:00:00','2025-12-11 20:10:00','member','active'),(3,'member003','hash_m003','2025-01-04 09:00:00','2025-12-12 20:10:00','member','active'),(4,'member004','hash_m004','2025-01-05 09:00:00','2025-12-13 20:10:00','member','active'),(5,'member005','hash_m005','2025-01-06 09:00:00','2025-12-14 20:10:00','member','active'),(6,'member006','hash_m006','2025-01-07 09:00:00','2025-12-15 20:10:00','member','active'),(7,'member007','hash_m007','2025-01-08 09:00:00','2025-12-16 20:10:00','member','active'),(8,'member008','hash_m008','2025-01-09 09:00:00','2025-12-17 20:10:00','member','active'),(9,'member009','hash_m009','2025-01-10 09:00:00','2025-12-18 20:10:00','member','active'),(10,'member010','hash_m010','2025-01-11 09:00:00','2025-12-09 20:10:00','member','active'),(11,'member011','hash_m011','2025-01-12 09:00:00','2025-12-10 20:10:00','member','active'),(12,'member012','hash_m012','2025-01-13 09:00:00','2025-12-11 20:10:00','member','active'),(13,'member013','hash_m013','2025-01-14 09:00:00','2025-12-12 20:10:00','member','active'),(14,'member014','hash_m014','2025-01-15 09:00:00','2025-12-13 20:10:00','member','active'),(15,'member015','hash_m015','2025-01-16 09:00:00','2025-12-14 20:10:00','member','active'),(16,'member016','hash_m016','2025-01-17 09:00:00','2025-12-15 20:10:00','member','active'),(17,'member017','hash_m017','2025-01-18 09:00:00','2025-12-16 20:10:00','member','active'),(18,'member018','hash_m018','2025-01-19 09:00:00','2025-12-17 20:10:00','member','active'),(19,'member019','hash_m019','2025-01-20 09:00:00','2025-12-18 20:10:00','member','active'),(20,'member020','hash_m020','2025-01-21 09:00:00','2025-12-09 20:10:00','member','active'),(21,'member021','hash_m021','2025-01-22 09:00:00','2025-12-10 20:10:00','member','active'),(22,'member022','hash_m022','2025-01-23 09:00:00','2025-12-11 20:10:00','member','active'),(23,'member023','hash_m023','2025-01-24 09:00:00','2025-12-12 20:10:00','member','active'),(24,'member024','hash_m024','2025-01-25 09:00:00','2025-12-13 20:10:00','member','active'),(25,'member025','hash_m025','2025-01-26 09:00:00','2025-12-14 20:10:00','member','active'),(26,'member026','hash_m026','2025-01-27 09:00:00','2025-12-15 20:10:00','member','active'),(27,'member027','hash_m027','2025-01-28 09:00:00','2025-12-16 20:10:00','member','active'),(28,'member028','hash_m028','2025-01-29 09:00:00','2025-12-17 20:10:00','member','active'),(29,'member029','hash_m029','2025-01-30 09:00:00','2025-12-18 20:10:00','member','active'),(30,'member030','hash_m030','2025-01-31 09:00:00','2025-12-09 20:10:00','member','active'),(31,'member031','hash_m031','2025-02-01 09:00:00','2025-12-10 20:10:00','member','active'),(32,'member032','hash_m032','2025-02-02 09:00:00','2025-12-11 20:10:00','member','active'),(33,'member033','hash_m033','2025-02-03 09:00:00','2025-12-12 20:10:00','member','active'),(34,'member034','hash_m034','2025-02-04 09:00:00','2025-12-13 20:10:00','member','active'),(35,'member035','hash_m035','2025-02-05 09:00:00','2025-12-14 20:10:00','member','active'),(36,'member036','hash_m036','2025-02-06 09:00:00','2025-12-15 20:10:00','member','active'),(37,'member037','hash_m037','2025-02-07 09:00:00','2025-12-16 20:10:00','member','active'),(38,'member038','hash_m038','2025-02-08 09:00:00','2025-12-17 20:10:00','member','active'),(39,'member039','hash_m039','2025-02-09 09:00:00','2025-12-18 20:10:00','member','active'),(40,'member040','hash_m040','2025-02-10 09:00:00','2025-12-09 20:10:00','member','active'),(41,'member041','hash_m041','2025-02-11 09:00:00','2025-12-10 20:10:00','member','active'),(42,'member042','hash_m042','2025-02-12 09:00:00','2025-12-11 20:10:00','member','active'),(43,'member043','hash_m043','2025-02-13 09:00:00','2025-12-12 20:10:00','member','active'),(44,'member044','hash_m044','2025-02-14 09:00:00','2025-12-13 20:10:00','member','active'),(45,'member045','hash_m045','2025-02-15 09:00:00','2025-12-14 20:10:00','member','active'),(46,'member046','hash_m046','2025-02-16 09:00:00','2025-12-15 20:10:00','member','active'),(47,'member047','hash_m047','2025-02-17 09:00:00','2025-12-16 20:10:00','member','active'),(48,'member048','hash_m048','2025-02-18 09:00:00','2025-12-17 20:10:00','member','active'),(49,'member049','hash_m049','2025-02-19 09:00:00','2025-12-18 20:10:00','member','active'),(50,'member050','hash_m050','2025-02-20 09:00:00','2025-12-09 20:10:00','member','active'),(51,'member051','hash_m051','2025-02-21 09:00:00','2025-12-10 20:10:00','member','active'),(52,'member052','hash_m052','2025-02-22 09:00:00','2025-12-11 20:10:00','member','active'),(53,'member053','hash_m053','2025-02-23 09:00:00','2025-12-12 20:10:00','member','active'),(54,'member054','hash_m054','2025-02-24 09:00:00','2025-12-13 20:10:00','member','active'),(55,'member055','hash_m055','2025-02-25 09:00:00','2025-12-14 20:10:00','member','active'),(56,'member056','hash_m056','2025-02-26 09:00:00','2025-12-15 20:10:00','member','active'),(57,'member057','hash_m057','2025-02-27 09:00:00','2025-12-16 20:10:00','member','active'),(58,'member058','hash_m058','2025-02-28 09:00:00','2025-12-17 20:10:00','member','active'),(59,'member059','hash_m059','2025-03-01 09:00:00','2025-12-18 20:10:00','member','active'),(60,'member060','hash_m060','2025-03-02 09:00:00','2025-12-09 20:10:00','member','active'),(61,'member061','hash_m061','2025-03-03 09:00:00','2025-12-10 20:10:00','member','active'),(62,'member062','hash_m062','2025-03-04 09:00:00','2025-12-11 20:10:00','member','active'),(63,'member063','hash_m063','2025-03-05 09:00:00','2025-12-12 20:10:00','member','active'),(64,'member064','hash_m064','2025-03-06 09:00:00','2025-12-13 20:10:00','member','active'),(65,'member065','hash_m065','2025-03-07 09:00:00','2025-12-14 20:10:00','member','active'),(66,'member066','hash_m066','2025-03-08 09:00:00','2025-12-15 20:10:00','member','active'),(67,'member067','hash_m067','2025-03-09 09:00:00','2025-12-16 20:10:00','member','active'),(68,'member068','hash_m068','2025-03-10 09:00:00','2025-12-17 20:10:00','member','active'),(69,'member069','hash_m069','2025-03-11 09:00:00','2025-12-18 20:10:00','member','active'),(70,'member070','hash_m070','2025-03-12 09:00:00','2025-12-09 20:10:00','member','active'),(71,'member071','hash_m071','2025-03-13 09:00:00','2025-12-10 20:10:00','member','active'),(72,'member072','hash_m072','2025-03-14 09:00:00','2025-12-11 20:10:00','member','active'),(73,'member073','hash_m073','2025-03-15 09:00:00','2025-12-12 20:10:00','member','active'),(74,'member074','hash_m074','2025-03-16 09:00:00','2025-12-13 20:10:00','member','active'),(75,'member075','hash_m075','2025-03-17 09:00:00','2025-12-14 20:10:00','member','active'),(76,'member076','hash_m076','2025-03-18 09:00:00','2025-12-15 20:10:00','member','active'),(77,'member077','hash_m077','2025-03-19 09:00:00','2025-12-16 20:10:00','member','active'),(78,'emp001','hash_e001','2024-11-01 08:30:00','2025-12-18 09:05:00','employee','active'),(79,'emp002','hash_e002','2024-11-08 08:30:00','2025-12-18 09:05:00','employee','active'),(80,'emp003','hash_e003','2024-11-15 08:30:00','2025-12-18 09:05:00','employee','active'),(81,'emp004','hash_e004','2024-11-22 08:30:00','2025-12-18 09:05:00','employee','active'),(82,'emp005','hash_e005','2024-11-29 08:30:00','2025-12-18 09:05:00','employee','active'),(83,'emp006','hash_e006','2024-12-06 08:30:00','2025-12-18 09:05:00','employee','active'),(84,'emp007','hash_e007','2024-12-13 08:30:00','2025-12-18 09:05:00','employee','active'),(85,'emp008','hash_e008','2024-12-20 08:30:00','2025-12-18 09:05:00','employee','active'),(86,'emp009','hash_e009','2025-01-03 08:30:00','2025-12-18 09:05:00','employee','active'),(87,'emp010','hash_e010','2025-01-10 08:30:00','2025-12-18 09:05:00','employee','active'),(88,'emp011','hash_e011','2025-01-17 08:30:00','2025-12-18 09:05:00','employee','active'),(89,'emp012','hash_e012','2025-01-24 08:30:00','2025-12-18 09:05:00','employee','active'),(90,'emp013','hash_e013','2025-01-31 08:30:00','2025-12-18 09:05:00','employee','active'),(91,'emp014','hash_e014','2025-02-07 08:30:00','2025-12-18 09:05:00','employee','active'),(92,'emp015','hash_e015','2025-02-14 08:30:00','2025-12-18 09:05:00','employee','active'),(93,'emp016','hash_e016','2025-02-21 08:30:00','2025-12-18 09:05:00','employee','active'),(94,'emp017','hash_e017','2025-02-28 08:30:00','2025-12-18 09:05:00','employee','active'),(95,'emp018','hash_e018','2025-03-07 08:30:00','2025-12-18 09:05:00','employee','active'),(96,'emp019','hash_e019','2025-03-14 08:30:00','2025-12-18 09:05:00','employee','active'),(97,'emp020','hash_e020','2025-03-21 08:30:00','2025-12-18 09:05:00','employee','active'),(98,'emp021','hash_e021','2025-03-28 08:30:00','2025-12-18 09:05:00','employee','active'),(99,'emp022','hash_e022','2025-04-04 08:30:00','2025-12-18 09:05:00','employee','active'),(100,'emp023','hash_e023','2025-04-11 08:30:00','2025-12-18 09:05:00','employee','active');
/*!40000 ALTER TABLE `users` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `vm_customer_notifications_homepage`
--

DROP TABLE IF EXISTS `vm_customer_notifications_homepage`;
/*!50001 DROP VIEW IF EXISTS `vm_customer_notifications_homepage`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vm_customer_notifications_homepage` AS SELECT 
...
--
-- Temporary view structure for view `vm_finance_invoice_base`
--

DROP TABLE IF EXISTS `vm_finance_invoice_base`;
/*!50001 DROP VIEW IF EXISTS `vm_finance_invoice_base`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vm_finance_invoice_base` AS SELECT 
 1 AS `invoice_id`,
 1 AS `order_id`,
 1 AS `store_id`,
 1 AS `member_id`,
...
--
-- Temporary view structure for view `vm_finance_invoice_paid_sum`
--

DROP TABLE IF EXISTS `vm_finance_invoice_paid_sum`;
/*!50001 DROP VIEW IF EXISTS `vm_finance_invoice_paid_sum`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vm_finance_invoice_paid_sum` AS SELECT 
 1 AS `invoice_id`,
 1 AS `paid_amount`,
 1 AS `last_paid_at`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `vm_finance_invoice_payment_allocation_detail`
--

DROP TABLE IF EXISTS `vm_finance_invoice_payment_allocation_detail`;
/*!50001 DROP VIEW IF EXISTS `vm_finance_invoice_payment_allocation_detail`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vm_finance_invoice_payment_allocation_detail` AS SELECT 
 1 AS `invoice_id`,
 1 AS `payment_id`,
 1 AS `allocation_date`,
 1 AS `allocated_amount`,
 1 AS `allocation_note`,
 1 AS `member_id`,
 1 AS `payment_method`,
 1 AS `payment_amount`,
 1 AS `payment_create_date`,
 1 AS `payment_update_date`,
 1 AS `payment_note`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vm_finance_order_amount_base`
--

DROP TABLE IF EXISTS `vm_finance_order_amount_base`;
/*!50001 DROP VIEW IF EXISTS `vm_finance_order_amount_base`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vm_finance_order_amount_base` AS SELECT 
 1 AS `order_id`,
 1 AS `store_id`,
 1 AS `member_id`,
 1 AS `order_status`,
...
--
-- Temporary view structure for view `vm_finance_order_member_rate`
--

DROP TABLE IF EXISTS `vm_finance_order_member_rate`;
/*!50001 DROP VIEW IF EXISTS `vm_finance_order_member_rate`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vm_finance_order_member_rate` AS SELECT 
 1 AS `order_id`,
 1 AS `member_tier_id`,
 1 AS `discount_rate`,
 1 AS `earn_point_rate`,
 1 AS `min_lifetime_spend`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vm_finance_order_paid_sum`
--

DROP TABLE IF EXISTS `vm_finance_order_paid_sum`;
/*!50001 DROP VIEW IF EXISTS `vm_finance_order_paid_sum`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vm_finance_order_paid_sum` AS SELECT 
 1 AS `order_id`,
 1 AS `paid_amount`,
 1 AS `last_paid_at`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `vm_finance_order_points_summary`
--

DROP TABLE IF EXISTS `vm_finance_order_points_summary`;
/*!50001 DROP VIEW IF EXISTS `vm_finance_order_points_summary`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vm_finance_order_points_summary` AS SELECT 
 1 AS `order_id`,
 1 AS `points_net`,
 1 AS `points_earned`,
 1 AS `points_redeemed`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vm_finance_order_settlement`
--

DROP TABLE IF EXISTS `vm_finance_order_settlement`;
/*!50001 DROP VIEW IF EXISTS `vm_finance_order_settlement`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vm_finance_order_settlement` AS SELECT 
 1 AS `order_id`,
 1 AS `store_id`,
 1 AS `member_id`,
 1 AS `order_status`,
 ...
 1 AS `earn_point_rate`,
 1 AS `gross_amount`,
 1 AS `discounted_amount`,
 1 AS `earned_points`,
 1 AS `redeemed_points`,
 1 AS `points_discount_amount`,
 1 AS `payable_amount`,
 1 AS `paid_amount`,
 1 AS `last_paid_at`,
 1 AS `is_settled`,
 1 AS `expected_earned_points`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vm_invoice_settlement`
--

DROP TABLE IF EXISTS `vm_invoice_settlement`;
/*!50001 DROP VIEW IF EXISTS `vm_invoice_settlement`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vm_invoice_settlement` AS SELECT 
 1 AS `invoice_id`,
 1 AS `invoice_number`,
 1 AS `invoice_status`,
 1 AS `issue_date`,
...
--
-- Temporary view structure for view `vm_manager_inventory_overview_with_batches`
--

DROP TABLE IF EXISTS `vm_manager_inventory_overview_with_batches`;
/*!50001 DROP VIEW IF EXISTS `vm_manager_inventory_overview_with_batches`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vm_manager_inventory_overview_with_batches` AS SELECT 
 1 AS `store_id`,
 1 AS `store_name`,
 1 AS `sku_id`,
 1 AS `ISBN`,
 ...
 1 AS `purchase_date`,
 1 AS `batch_quantity`,
 1 AS `batch_unit_cost`,
 1 AS `batch_received_date`,
 1 AS `current_stock`,
 1 AS `last_restock`,
 1 AS `stock_status`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `vm_manager_notifications`
--

DROP TABLE IF EXISTS `vm_manager_notifications`;
/*!50001 DROP VIEW IF EXISTS `vm_manager_notifications`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vm_manager_notifications` AS SELECT 
 1 AS `announcement_id`,
 1 AS `title`,
 1 AS `content`,
 1 AS `publish_at`,
...
--
-- Temporary view structure for view `vm_manager_request_detail`
--

DROP TABLE IF EXISTS `vm_manager_request_detail`;
/*!50001 DROP VIEW IF EXISTS `vm_manager_request_detail`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vm_manager_request_detail` AS SELECT 
 1 AS `request_id`,
 1 AS `status`,
 1 AS `request_time`,
 1 AS `note`,
 ...
 1 AS `requested_qty`,
 1 AS `unified_price`,
 1 AS `suggested_average_unit_cost`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vm_manager_request_list`
--

DROP TABLE IF EXISTS `vm_manager_request_list`;
/*!50001 DROP VIEW IF EXISTS `vm_manager_request_list`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vm_manager_request_list` AS SELECT 
 1 AS `request_id`,
 1 AS `store_id`,
 1 AS `branch_name`,
 1 AS `supplier_id`,
 ...
 1 AS `status`,
 1 AS `note`,
 1 AS `requested_sku_count`,
 1 AS `requested_total_qty`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vm_manager_staff_management`
--

DROP TABLE IF EXISTS `vm_manager_staff_management`;
/*!50001 DROP VIEW IF EXISTS `vm_manager_staff_management`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vm_manager_staff_management` AS SELECT 
 1 AS `employee_id`,
 1 AS `user_id`,
 1 AS `user_name`,
 1 AS `user_type`,
 ...
 1 AS `phone`,
 1 AS `performance`,
 1 AS `account_created_at`,
 1 AS `last_login_at`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vm_manager_user_account_admin`
--

DROP TABLE IF EXISTS `vm_manager_user_account_admin`;
/*!50001 DROP VIEW IF EXISTS `vm_manager_user_account_admin`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vm_manager_user_account_admin` AS SELECT 
 1 AS `user_id`,
 1 AS `username`,
 1 AS `user_types`,
 1 AS `status`,
...
--
-- Final view structure for view `vm_customer_notifications_homepage`
--
...
/*!50001 VIEW `vm_customer_notifications_homepage` AS select `a`.`announcement_id` AS `announcement_id`,`a`.`title` AS `title`,`a`.`content` AS `content`,`a`.`publish_at` AS `publish_at`,`a`.`expire_at` AS `expire_at`,cast(`a`.`publish_at` as date) AS `display_date` from `announcements` `a` where ((`a`.`publish_at` <= now()) and ((`a`.`expire_at` is null) or (`a`.`expire_at` >= now()))) order by `a`.`publish_at` desc */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vm_finance_invoice_base`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vm_finance_invoice_paid_sum` AS select `pa`.`invoice_id` AS `invoice_id`,round(sum(`pa`.`allocated_amount`),2) AS `paid_amount`,max(`pa`.`create_date`) AS `last_paid_at` from `payment_allocations` `pa` group by `pa`.`invoice_id` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vm_finance_invoice_payment_allocation_detail`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vm_finance_order_amount_base` AS select `o`.`order_id` AS `order_id`,`o`.`store_id` AS `store_id`,`o`.`member_id` AS `member_id`,`o`.`order_status` AS `order_status`,`o`.`order_date` AS `order_date`,ifnull(sum((`oi`.`quantity` * `s`.`unit_price`)),0) AS `gross_amount` from ((`orders` `o` left join `order_items` `oi` on((`oi`.`order_id` = `o`.`order_id`))) left join `skus` `s` on((`s`.`sku_id` = `oi`.`sku_id`))) group by `o`.`order_id`,`o`.`store_id`,`o`.`member_id`,`o`.`order_status`,`o`.`order_date` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vm_finance_order_member_rate`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vm_finance_order_paid_sum` AS select `i`.`order_id` AS `order_id`,ifnull(sum(`pa`.`allocated_amount`),0) AS `paid_amount`,max(`pa`.`create_date`) AS `last_paid_at` from (`invoices` `i` left join `payment_allocations` `pa` on((`pa`.`invoice_id` = `i`.`invoice_id`))) group by `i`.`order_id` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vm_finance_order_points_summary`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vm_finance_order_points_summary` AS select `pl`.`order_id` AS `order_id`,sum(`pl`.`points_delta`) AS `points_net`,sum((case when (`pl`.`points_delta` > 0) then `pl`.`points_delta` else 0 end)) AS `points_earned`,sum((case when (`pl`.`points_delta` < 0) then -(`pl`.`points_delta`) else 0 end)) AS `points_redeemed` from `point_ledgers` `pl` group by `pl`.`order_id` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vm_finance_order_settlement`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vm_finance_order_settlement` AS select `b`.`order_id` AS `order_id`,`b`.`store_id` AS `store_id`,`b`.`member_id` AS `member_id`,`b`.`order_status` AS `order_status`,`b`.`order_date` AS `order_date`,`r`.`discount_rate` AS `discount_rate`,`r`.`earn_point_rate` AS `earn_point_rate`,`b`.`gross_amount` AS `gross_amount`,round((`b`.`gross_amount` * `r`.`discount_rate`),2) AS `discounted_amount`,ifnull(`p`.`points_earned`,0) AS `earned_points`,ifnull(`p`.`points_redeemed`,0) AS `redeemed_points`,round((case when ((`r`.`earn_point_rate` is null) or (`r`.`earn_point_rate` = 0)) then 0 else (ifnull(`p`.`points_redeemed`,0) / `r`.`earn_point_rate`) end),2) AS `points_discount_amount`,round(greatest(((`b`.`gross_amount` * `r`.`discount_rate`) - (case when ((`r`.`earn_point_rate` is null) or (`r`.`earn_point_rate` = 0)) then 0 else (ifnull(`p`.`points_redeemed`,0) / `r`.`earn_point_rate`) end)),0),2) AS `payable_amount`,ifnull(`ps`.`paid_amount`,0) AS `paid_amount`,`ps`.`last_paid_at` AS `last_paid_at`,(case when (ifnull(`ps`.`paid_amount`,0) >= round(greatest(((`b`.`gross_amount` * `r`.`discount_rate`) - (case when ((`r`.`earn_point_rate` is null) or (`r`.`earn_point_rate` = 0)) then 0 else (ifnull(`p`.`points_redeemed`,0) / `r`.`earn_point_rate`) end)),0),2)) then 1 else 0 end) AS `is_settled`,floor((round(greatest((`b`.`gross_amount` * `r`.`discount_rate`),0),2) * `r`.`earn_point_rate`)) AS `expected_earned_points` from (((`vm_finance_order_amount_base` `b` left join `vm_finance_order_member_rate` `r` on((`r`.`order_id` = `b`.`order_id`))) left join `vm_finance_order_points_summary` `p` on((`p`.`order_id` = `b`.`order_id`))) left join `vm_finance_order_paid_sum` `ps` on((`ps`.`order_id` = `b`.`order_id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vm_invoice_settlement`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vm_manager_inventory_overview_with_batches` AS select `s`.`store_id` AS `store_id`,`s`.`name` AS `store_name`,`sk`.`sku_id` AS `sku_id`,`sk`.`ISBN` AS `ISBN`,`b`.`name` AS `book_title`,`sk`.`unit_price` AS `unit_price`,`sk`.`binding` AS `binding`,`ib`.`batch_id` AS `batch_id`,`ib`.`batch_code` AS `batch_code`,`ib`.`purchase_id` AS `purchase_id`,`p`.`status` AS `purchase_status`,`p`.`purchase_date` AS `purchase_date`,`ib`.`quantity` AS `batch_quantity`,`ib`.`unit_cost` AS `batch_unit_cost`,`ib`.`received_date` AS `batch_received_date`,sum(`ib`.`quantity`) OVER (PARTITION BY `ib`.`store_id`,`ib`.`sku_id` )  AS `current_stock`,max(`ib`.`received_date`) OVER (PARTITION BY `ib`.`store_id`,`ib`.`sku_id` )  AS `last_restock`,(case when (sum(`ib`.`quantity`) OVER (PARTITION BY `ib`.`store_id`,`ib`.`sku_id` )  <= 5) then 'Low' else 'Good' end) AS `stock_status` from ((((`inventory_batches` `ib` join `stores` `s` on((`s`.`store_id` = `ib`.`store_id`))) join `skus` `sk` on((`sk`.`sku_id` = `ib`.`sku_id`))) join `books` `b` on((`b`.`ISBN` = `sk`.`ISBN`))) left join `purchases` `p` on((`p`.`purchase_id` = `ib`.`purchase_id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vm_manager_notifications`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vm_manager_notifications` AS select `a`.`announcement_id` AS `announcement_id`,`a`.`title` AS `title`,`a`.`content` AS `content`,`a`.`publish_at` AS `publish_at`,`a`.`expire_at` AS `expire_at`,cast(`a`.`publish_at` as date) AS `display_date` from `announcements` `a` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vm_manager_request_detail`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vm_manager_request_detail` AS select `p`.`purchase_id` AS `request_id`,`p`.`status` AS `status`,`p`.`purchase_date` AS `request_time`,`p`.`note` AS `note`,`st`.`store_id` AS `store_id`,`st`.`name` AS `branch_name`,`pi`.`sku_id` AS `sku_id`,`b`.`ISBN` AS `ISBN`,`b`.`name` AS `book_title`,`sk`.`binding` AS `binding`,`pi`.`quantity` AS `requested_qty`,`sk`.`unit_price` AS `unified_price`,(select avg(`ib`.`unit_cost`) from `inventory_batches` `ib` where (`ib`.`sku_id` = `pi`.`sku_id`)) AS `suggested_average_unit_cost` from ((((`purchases` `p` join `stores` `st` on((`st`.`store_id` = `p`.`store_id`))) join `purchase_items` `pi` on((`pi`.`purchase_id` = `p`.`purchase_id`))) join `skus` `sk` on((`sk`.`sku_id` = `pi`.`sku_id`))) join `books` `b` on((`b`.`ISBN` = `sk`.`ISBN`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vm_manager_request_list`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vm_manager_request_list` AS select `p`.`purchase_id` AS `request_id`,`p`.`store_id` AS `store_id`,`st`.`name` AS `branch_name`,`p`.`supplier_id` AS `supplier_id`,`sp`.`name` AS `supplier_name`,`p`.`purchase_date` AS `request_time`,`p`.`status` AS `status`,`p`.`note` AS `note`,count(distinct `pi`.`sku_id`) AS `requested_sku_count`,coalesce(sum(`pi`.`quantity`),0) AS `requested_total_qty` from (((`purchases` `p` join `stores` `st` on((`st`.`store_id` = `p`.`store_id`))) left join `suppliers` `sp` on((`sp`.`supplier_id` = `p`.`supplier_id`))) left join `purchase_items` `pi` on((`pi`.`purchase_id` = `p`.`purchase_id`))) group by `p`.`purchase_id`,`p`.`store_id`,`st`.`name`,`p`.`supplier_id`,`sp`.`name`,`p`.`purchase_date`,`p`.`status`,`p`.`note` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vm_manager_staff_management`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vm_manager_staff_management` AS select `e`.`employee_id` AS `employee_id`,`u`.`user_id` AS `user_id`,`u`.`username` AS `user_name`,`u`.`user_types` AS `user_type`,`s`.`store_id` AS `store_id`,`s`.`name` AS `branch_name`,`s`.`status` AS `branch_status`,`e`.`first_name` AS `first_name`,`e`.`last_name` AS `last_name`,trim(concat(`e`.`first_name`,' ',`e`.`last_name`)) AS `full_name`,`jt`.`job_title_id` AS `job_title_id`,`jt`.`name` AS `position_name`,`jt`.`base_salary` AS `base_salary`,`e`.`phone` AS `phone`,`e`.`performance` AS `performance`,`u`.`create_date` AS `account_created_at`,`u`.`last_log_date` AS `last_login_at` from (((`employees` `e` join `users` `u` on((`u`.`user_id` = `e`.`user_id`))) join `stores` `s` on((`s`.`store_id` = `e`.`store_id`))) join `job_titles` `jt` on((`jt`.`job_title_id` = `e`.`job_title_id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vm_manager_user_account_admin`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vm_manager_user_account_admin` AS select `u`.`user_id` AS `user_id`,`u`.`username` AS `username`,`u`.`user_types` AS `user_types`,`u`.`status` AS `status`,`u`.`create_date` AS `create_date`,`u`.`last_log_date` AS `last_log_date`,timestampdiff(DAY,`u`.`last_log_date`,now()) AS `days_since_last_login` from `users` `u` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2025-12-26 17:30:23
