...
### Business Workflows
- **Customer Journey:** Browse → Add to Cart → Checkout → Payment → Order Tracking
- **Inventory Management:** Stock Monitoring → Low Stock Alert → Replenishment Request → Supplier Order
- **Order Processing:** Order Received → Processing → Shipped → Delivered
- **Financial Tracking:** Order Payment → Invoice Generation → Financial Reporting
...
- [XAMPP部署指南](在xampp上的部署步骤. md)
- [Finance SQL使用方法](finance的sql文件使用方法.md)
